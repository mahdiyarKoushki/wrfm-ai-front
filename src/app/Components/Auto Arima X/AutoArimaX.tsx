...
import { NewArimaPosts, NewArimaPostsStepTWO, NewAutoArimaPosts, NewAutoArimaXPosts } from "@/api-client/api-client";
  ...
  return (
    <div className="min-h-screen w-full bg-gray-950 text-gray-100 px-10 ">
      <div className="mx-auto h-full container">
        ...
        <Header rout="/Prediction" title={"Auto ARIMA X Algorithm"} />
        </div>

        {/* Main Grid */}
        <div className="w-full h-[calc(100vh_-_150px)] flex items-center justify-center ">
        <div className="lg:col-span-5 space-y-6 bg-[#262626] p-5 rounded-xl  flex flex-col gap-15 w-1/2 mx-auto ">
            {/* First Item */}
