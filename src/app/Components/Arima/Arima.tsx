...
import { NewArimaPosts, NewArimaPostsStepTWO } from "@/api-client/api-client";
...
export default function Arima() {
  ...
  const fetchArimaNew = async (wellName = well) => {
    ...
    try {
      ...
      console.error("Error fetching ARIMA data:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchArimaNewTWO = async (wellName = well) => {
    ...
    try {
      ...
      const res = await NewArimaPostsStepTWO(params);
      const dataChart = {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-950 text-gray-100 px-10">
      <div className="mx-auto w-full">
        ...
        {/* Header */}
        <Header rout="/Prediction" title="ARIMA Algorithm" />
        ...
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="flex gap-15">
              ...
              <div className="w-full">
                ...
                <div className="flex items-center gap-4 mt-4">
                  <p className="flex w-3/2">Train Percentage</p>
                  <Slider
          ...
          <div className="lg:col-span-7 space-y-6 h-full w-full">
            ...
            <ChartArima title="Partial Autocorrelation (PACF)" dataChart={chartPACFdata} />
          </div>
        </div>
