  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      <div
        ...
        className={`flex min-h-[56px] w-full items-center justify-between rounded-md border px-3 py-2 text-sm transition-all
          ${open ? " shadow-[0_0_0_2px_rgba(25,118,210,0.2)]" : "border-gray-300 hover:border-gray-400"}
        ...
        <div className="absolute z-10 mt-1 w-full rounded-md border border-gray-200 bg-white shadow-lg">
          <div className="p-2">
            <input
              ...
              className="w-full rounded-md border border-gray-300 p-2 text-sm focus: focus:outline-none focus:ring-1 focus:ring-blue-500"
